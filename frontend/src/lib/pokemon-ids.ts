/** Complete Gen 1 Pokemon name → PokeAPI ID map (all 151). Names are lowercase, matching the DB. */
export const GEN1_IDS: Record<string, number> = {
  bulbasaur: 1, ivysaur: 2, venusaur: 3, charmander: 4, charmeleon: 5, charizard: 6,
  squirtle: 7, wartortle: 8, blastoise: 9, caterpie: 10, metapod: 11, butterfree: 12,
  weedle: 13, kakuna: 14, beedrill: 15, pidgey: 16, pidgeotto: 17, pidgeot: 18,
  rattata: 19, raticate: 20, spearow: 21, fearow: 22, ekans: 23, arbok: 24,
  pikachu: 25, raichu: 26, sandshrew: 27, sandslash: 28,
  'nidoran-f': 29, nidorina: 30, nidoqueen: 31, 'nidoran-m': 32, nidorino: 33, nidoking: 34,
  ...
  'farfetch\'d': 83, farfetchd: 83, doduo: 84, dodrio: 85,
  seel: 86, dewgong: 87, grimer: 88, muk: 89, shellder: 90, cloyster: 91,
  ...
  staryu: 120, starmie: 121, 'mr. mime': 122, 'mr-mime': 122, mrmime: 122,
  scyther: 123, jynx: 124, electabuzz: 125, magmar: 126, pinsir: 127,
  tauros: 128, magikarp: 129, gyarados: 130, lapras: 131, ditto: 132,
...
export function getPokeapiId(name: string): number {
  return GEN1_IDS[name.toLowerCase()] ?? 0;
}
